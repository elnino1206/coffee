...
<template>
        ...
        <div class="hero__grid container">
            <div class="hero__copy">
                ...
                <div class="trust-row">
                    ...
                    >
                    <span class="trust-item">Обжарка небольшими партиями</span>
                    <span class="trust-item"
    ...
    <section class="section">
        <div class="container">
            ...
            <h2 class="h2" style="margin-bottom: 24px">Три шага до ритуала</h2>
            <div class="steps">
                <article class="step">
                    <span class="step__n">1</span>
                    <h3 class="h3">Выбираете кофе</h3>
                    <p class="muted">
                        Объём, помол и частоту доставки — под ваш вкус и ритм.
                    </p>
                </article>
                <article class="step">
                    ...
                    <p class="muted">
                        Обжариваем небольшими партиями и привозим к нужной дате.
                    </p>
                </article>
                <article class="step">
                    ...
                    <p class="muted">
                        Всегда свежий кофе без забот. Пауза или отмена — в любой
                        момент.
                    </p>
                </article>
            </div>
        ...
        <div class="container">
            ...
            <div class="compare">
                <div class="compare-card">
                    ...
                    <p class="muted">
                        Одна покупка · без обжарки под вас · без регулярной
                        доставки
                    </p>
                </div>
    ...
    <section class="section" id="constructor">
        <div class="constructor container">
            ...
            <form @submit.prevent>
                ...
                <p class="tiny">
                    Оформление подключается вместе со списаниями по карте:
                    подписка снимает деньги сама, и без платёжного контура это
                    было бы обещанием без покрытия. Пока страница считает цену
                    по действующему прайсу.
                </p>
            </form>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="accordion">
                <details>
                    <summary>Как отменить или приостановить подписку?</summary>
                    <p>
                        В личном кабинете: «Пауза» или «Отменить». Перед отменой
                        покажем удерживающее предложение — без тёмных паттернов,
                        решение за вами.
                    </p>
                </details>
                <details>
                    <summary>Можно ли изменить заказ или помол?</summary>
                    <p>
                        Да. Сорт, объём, помол и частоту меняете до следующей
                        обжарки — обычно за несколько дней до доставки.
                    </p>
                </details>
                <details>
                    <summary>Из какого кофе вы обжариваете?</summary>
                    <p>
                        Арабика под эспрессо и ливанский кофе, а также лоты под
                        фильтр. Актуальный список — в каталоге, с профилем вкуса
                        на каждой карточке.
                    </p>
                </details>
            </div>
