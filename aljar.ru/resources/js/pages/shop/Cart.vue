        ...
        <div class="checkout">
            <div ref="list">
                ...
                <div v-if="upsell.length" style="margin-top: 32px">
                    <h2 class="h3" style="margin-bottom: 12px">
                        Добавить к заказу
                    </h2>
                    <div class="product-grid product-grid--upsell">
                        <article
                            v-for="product in upsell"
                            :key="product.slug"
                            class="card"
                            data-reveal
                        >
            ...
            <aside v-if="items.length" class="summary">
                ...
                <div class="totals">
                    ...
                    <div class="grand">
                        <span>К оплате</span
                        ><span>{{ formatPrice(goods_total + delivery) }}</span>
                    </div>
                </div>
                <p class="tiny">
                    Бесплатная доставка от {{ formatPrice(free_delivery_from) }}
                </p>
                <Link class="btn btn--petrol btn--block" href="/checkout"
                    >Оформить заказ</Link
                >
            </aside>
        </div>
